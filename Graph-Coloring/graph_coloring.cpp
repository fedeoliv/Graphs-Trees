...
/*  Graph coloring: Given m colors, find a way of coloring the vertices of a graph
    such that no two adjacent vertices are colored using same color.
    Output: Vertex 0 --->  Color 0
            Vertex 1 --->  Color 1
            Vertex 2 --->  Color 2
            Vertex 3 --->  Color 0 */
